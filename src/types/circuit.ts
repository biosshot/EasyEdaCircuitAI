...
const BaseComponentSchema = () => z.object({
    ...
    searchQuery: z.string().describe('A component search question. For example: "1k 1W smd resistor", "LM358", "2-pin power connector"'),
    partUuid: z.string().nullable().describe("If you know the partUuid of the lcsc component, be sure to fill it in")
});
...
const BlockSchema = () => z.object({
    ...
    nextBlocks: z.array(z.string().describe("The `name` of the next block must be an existing block `name`."))
});
